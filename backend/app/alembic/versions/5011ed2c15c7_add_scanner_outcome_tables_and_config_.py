...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_scanner_outcome_snapshots_id"),
        "scanner_outcome_snapshots",
        ["id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_scanner_outcome_snapshots_scanner_event_id"),
        "scanner_outcome_snapshots",
        ["scanner_event_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_scanner_outcome_snapshots_status"),
        "scanner_outcome_snapshots",
        ["status"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_scanner_outcome_summaries_id"),
        "scanner_outcome_summaries",
        ["id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_scanner_outcome_summaries_is_complete"),
        "scanner_outcome_summaries",
        ["is_complete"],
        unique=False,
    )
    op.create_index(
        op.f("ix_scanner_outcome_summaries_scanner_event_id"),
        "scanner_outcome_summaries",
        ["scanner_event_id"],
        unique=True,
    )
    op.add_column(
        "scanner_configs",
        sa.Column(
            "outcome_config", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
    )
    op.add_column(
        "scanner_configs",
        sa.Column(
            "data_requirements", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_scanner_outcome_summaries_scanner_event_id"),
        table_name="scanner_outcome_summaries",
    )
    op.drop_index(
        op.f("ix_scanner_outcome_summaries_is_complete"),
        table_name="scanner_outcome_summaries",
    ...
    op.drop_index(
        op.f("ix_scanner_outcome_summaries_id"), table_name="scanner_outcome_summaries"
    )
    op.drop_table("scanner_outcome_summaries")
    op.drop_index(
        op.f("ix_scanner_outcome_snapshots_status"),
        table_name="scanner_outcome_snapshots",
    )
    op.drop_index(
        op.f("ix_scanner_outcome_snapshots_scanner_event_id"),
        table_name="scanner_outcome_snapshots",
    ...
    op.drop_index(
        op.f("ix_scanner_outcome_snapshots_id"), table_name="scanner_outcome_snapshots"
    )
