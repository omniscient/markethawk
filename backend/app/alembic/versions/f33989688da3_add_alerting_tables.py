...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "scanner_types", postgresql.JSONB(astext_type=sa.Text()), nullable=False
        ),
    ...
    op.create_index(
        op.f("ix_alert_delivery_logs_id"), "alert_delivery_logs", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_alert_delivery_logs_rule_id"),
        "alert_delivery_logs",
        ["rule_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_alert_delivery_logs_scanner_event_id"),
        "alert_delivery_logs",
        ["scanner_event_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_alert_delivery_logs_ticker"),
        "alert_delivery_logs",
        ["ticker"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_monitored_stocks_data_source"),
        "monitored_stocks",
        ["data_source"],
        unique=False,
    )
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(
        op.f("ix_monitored_stocks_data_source"), table_name="monitored_stocks"
    )
    op.alter_column(
        "monitored_stocks",
        "data_source",
    ...
    op.drop_index(
        op.f("ix_alert_delivery_logs_ticker"), table_name="alert_delivery_logs"
    )
    op.drop_index(
        op.f("ix_alert_delivery_logs_scanner_event_id"),
        table_name="alert_delivery_logs",
    )
    op.drop_index(
        op.f("ix_alert_delivery_logs_rule_id"), table_name="alert_delivery_logs"
    )
