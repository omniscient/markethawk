...
def upgrade() -> None:
    ...
    op.add_column('volume_events', sa.Column('outstanding_shares', sa.Numeric(), nullable=True))
    op.add_column('volume_events', sa.Column('float_rotation_pct', sa.Numeric(), nullable=True))
    op.add_column('volume_events', sa.Column('catalyst_tags', sa.JSON(), nullable=True))
    op.add_column('volume_events', sa.Column('catalyst_summary', sa.String(), nullable=True))
    op.add_column('volume_events', sa.Column('recent_split_date', sa.Date(), nullable=True))
