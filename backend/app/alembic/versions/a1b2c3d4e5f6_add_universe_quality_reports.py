...
def upgrade() -> None:
    ...
    """)
    op.execute("CREATE INDEX IF NOT EXISTS ix_universe_quality_reports_id ON universe_quality_reports (id)")
    ...
    op.create_index('ix_universe_quality_reports_id', 'universe_quality_reports', ['id'])
    op.create_index('ix_universe_quality_reports_universe_id', 'universe_quality_reports', ['universe_id'])


def downgrade() -> None:
    op.drop_index('ix_universe_quality_reports_universe_id', table_name='universe_quality_reports')
    op.drop_index('ix_universe_quality_reports_id', table_name='universe_quality_reports')
