...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_scanner_events_event_date"),
        "scanner_events",
        ["event_date"],
        unique=False,
    )
    op.create_index(
        op.f("ix_scanner_events_id"), "scanner_events", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_scanner_events_scanner_type"),
        "scanner_events",
        ["scanner_type"],
        unique=False,
    )
    op.create_index(
        op.f("ix_scanner_events_ticker"), "scanner_events", ["ticker"], unique=False
    )
    op.create_index(
        op.f("ix_scanner_events_uuid"), "scanner_events", ["uuid"], unique=True
    )
...
def downgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "pre_market_volume", sa.BIGINT(), autoincrement=False, nullable=False
        ),
        ...
        sa.Column(
            "volume_spike_ratio", sa.NUMERIC(), autoincrement=False, nullable=False
        ),
        ...
        sa.Column(
            "market_cap_at_event", sa.BIGINT(), autoincrement=False, nullable=True
        ),
        sa.Column(
            "raw_data",
            postgresql.JSONB(astext_type=sa.Text()),
        ...
        sa.Column(
            "fade_from_high_pct", sa.NUMERIC(), autoincrement=False, nullable=True
        ),
        ...
        sa.Column(
            "outstanding_shares", sa.NUMERIC(), autoincrement=False, nullable=True
        ),
        sa.Column(
            "float_rotation_pct", sa.NUMERIC(), autoincrement=False, nullable=True
        ),
        sa.Column(
            "catalyst_tags",
    ...
    op.create_index(
        "idx_volume_events_type", "volume_events", ["event_type"], unique=False
    )
    op.create_index(
        "idx_volume_events_ticker", "volume_events", ["ticker"], unique=False
    )
    op.create_index(
        "idx_volume_events_relative_vol",
        "volume_events",
        ["relative_volume"],
        unique=False,
    )
    op.create_index(
        "idx_volume_events_date", "volume_events", ["event_date"], unique=False
    )
