...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_monitored_accounts_id"), "monitored_accounts", ["id"], unique=False
    )
    op.create_table(
        "tweet_signals",
        sa.Column("id", sa.Integer(), nullable=False),
        ...
        sa.Column(
            "price_levels", postgresql.JSONB(astext_type=sa.Text()), nullable=False
        ),
    ...
    op.create_index(
        op.f("ix_tweet_signals_account_id"),
        "tweet_signals",
        ["account_id"],
        unique=False,
    )
    op.create_index(
        "ix_tweet_signals_account_posted",
        "tweet_signals",
        ["account_id", "posted_at"],
        unique=False,
    )
    op.create_index(
        "ix_tweet_signals_classification_confidence",
        "tweet_signals",
    ...
    op.create_index(
        "ix_tweet_signals_promoted_classification",
        "tweet_signals",
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.create_index(
        op.f("idx_scanner_events_score"),
        "scanner_events",
        [sa.literal_column("signal_quality_score DESC NULLS LAST")],
        unique=False,
    )
    op.create_table(
        "market_data_cache",
    ...
    op.drop_index(
        "ix_tweet_signals_promoted_classification", table_name="tweet_signals"
    )
    op.drop_index(op.f("ix_tweet_signals_id"), table_name="tweet_signals")
    op.drop_index(
        "ix_tweet_signals_classification_confidence", table_name="tweet_signals"
    )
