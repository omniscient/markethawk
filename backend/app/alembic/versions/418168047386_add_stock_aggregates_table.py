...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_stock_aggregates_id"), "stock_aggregates", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_stock_aggregates_is_pre_market"),
        "stock_aggregates",
        ["is_pre_market"],
        unique=False,
    )
    op.create_index(
        op.f("ix_stock_aggregates_ticker"), "stock_aggregates", ["ticker"], unique=False
    )
    op.create_index(
        op.f("ix_stock_aggregates_timestamp"),
        "stock_aggregates",
        ["timestamp"],
        unique=False,
    )
    op.create_index(
        "idx_ticker_time", "stock_aggregates", ["ticker", "timestamp"], unique=False
    )
    op.create_index(
        "idx_ticker_time_pre",
        "stock_aggregates",
        ["ticker", "timestamp", "is_pre_market"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_stock_aggregates_is_pre_market"), table_name="stock_aggregates"
    )
