...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "allowed_sessions", postgresql.JSONB(astext_type=sa.Text()), nullable=False
        ),
    ...
    op.create_index(
        op.f("ix_trading_strategies_id"), "trading_strategies", ["id"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["trading_strategy_id"], ["trading_strategies.id"], ondelete="SET NULL"
        ),
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint(
            "symbol",
    ...
    op.create_index(
        op.f("ix_auto_trade_orders_alert_rule_id"),
        "auto_trade_orders",
        ["alert_rule_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_auto_trade_orders_event_date"),
        "auto_trade_orders",
        ["event_date"],
        unique=False,
    )
    op.create_index(
        op.f("ix_auto_trade_orders_id"), "auto_trade_orders", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_auto_trade_orders_scanner_event_id"),
        "auto_trade_orders",
        ["scanner_event_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_auto_trade_orders_status"),
        "auto_trade_orders",
        ["status"],
        unique=False,
    )
    op.create_index(
        op.f("ix_auto_trade_orders_symbol"),
        "auto_trade_orders",
        ["symbol"],
        unique=False,
    )
    op.create_index(
        op.f("ix_auto_trade_orders_trade_id"),
        "auto_trade_orders",
        ["trade_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_auto_trade_orders_trading_strategy_id"),
        "auto_trade_orders",
        ["trading_strategy_id"],
        unique=False,
    )
    ...
    op.add_column(
        "alert_rules",
        sa.Column("auto_trade", sa.Boolean(), nullable=False, server_default="false"),
    )
    op.add_column(
        "alert_rules", sa.Column("trading_strategy_id", sa.Integer(), nullable=True)
    )
    op.create_index(
        op.f("ix_alert_rules_trading_strategy_id"),
        "alert_rules",
        ["trading_strategy_id"],
        unique=False,
    )
...
def downgrade() -> None:
    op.drop_constraint(
        "fk_alert_rules_trading_strategy_id", "alert_rules", type_="foreignkey"
    )
    ...
    op.drop_index(
        op.f("ix_auto_trade_orders_trading_strategy_id"), table_name="auto_trade_orders"
    )
    ...
    op.drop_index(
        op.f("ix_auto_trade_orders_scanner_event_id"), table_name="auto_trade_orders"
    )
    op.drop_index(op.f("ix_auto_trade_orders_id"), table_name="auto_trade_orders")
    op.drop_index(
        op.f("ix_auto_trade_orders_event_date"), table_name="auto_trade_orders"
    )
    op.drop_index(
        op.f("ix_auto_trade_orders_alert_rule_id"), table_name="auto_trade_orders"
    )
