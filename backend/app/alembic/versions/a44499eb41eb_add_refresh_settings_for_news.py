...
def upgrade() -> None:
    op.add_column('news_preferences', sa.Column('refresh_interval_minutes', sa.Integer(), nullable=True))
    op.add_column('news_preferences', sa.Column('last_polled_at', sa.DateTime(), nullable=True))
