...
from app.schemas.journal import (
    TradeSchema, TradeUpdate, TradeCreate,
    ExecutionSchema, ExecutionCreate,
    TagSchema, TagCreate,
    JournalEntrySchema, JournalEntryCreate,
    TradeStats
)
...
async def import_trades(
    ...
    results = journal_service.import_trades_from_csv(db, content.decode("utf-8"), broker)
    return results
